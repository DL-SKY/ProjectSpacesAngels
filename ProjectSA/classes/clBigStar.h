...
class clBigStar : virtual public clObject
{
...
public:
	...
	virtual ~clBigStar() { /*delete chName;*/ };
	clBigStar() { clObject::clObject(); SetName("Star"); iColour = _ColdBLUE_; iAlpha = 20; bAlphaUp = true; bCollisionPlayer = false; };
	//данные-члены
	int iColour;
	int iAlpha;
	bool bAlphaUp;
